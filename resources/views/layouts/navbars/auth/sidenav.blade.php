<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home') }}"
            target="_blank">
            <img src="{{ asset('img/logo.jpg') }}" class="navbar-brand-img h-100" style="width: 150px; height: 150px;" alt="main_logo">
<br>
<span><b><u>SCHOOL MANAGEMENT</u></b></span>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3 d-flex align-items-center">
                ...
                <h6 class="ms-2 text-uppercase text-xs font-weight-bolder opacity-6 mb-0">Students</h6>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">classes</h6>
            </li>
            <li class="nav-item">
