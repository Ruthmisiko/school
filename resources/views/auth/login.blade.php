                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-1 text-sm mx-auto">
                                        ...
                                        <a href="{{ route('reset-password.show') }}" class="text-primary text-gradient font-weight-bold">here</a>
                                    </p>
                                </div>
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                        ...
                        <div
                            ...
                            style="background-image: url('{{ asset('img/school.jpg') }}'); background-size: cover; background-position: center;">
